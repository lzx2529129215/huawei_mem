#!/usr/bin/env python3
"""Build fixed-dimension, labelled Douyu VMA vectors from collected windows.
...
ANON_SLOTS = 1024
PAGE_SIZE_KB = 4
SCHEMA_VERSION = "douyu.vma-dataset.v1"
...
def aggregate_report_features(report_paths: Iterable[Path]) -> dict[str, Any]:
    """Aggregate VMA referenced pages across all Douyu process reports."""
...
def build_dataset(root: Path) -> dict[str, Any]:
    ...
    for sequence in sequences:
        ...
        manifest = {
            ...
            "app_version": sequence.get("app_version", ""),
    ...
    manifest_fields = [
        ...
        "vector_nonzero_count", "document_path", "startup_state", "device_target", "system_version", "app_version",
